              ...
              Column(
                children: const [
                  _BlogCard(
                    ...
                    title: "전문가의 빈칸",
                    description:
                        " 여기서만 제공되는 특별한 파트너십과 혜택 마스터카드 마스터카드 특별 혜택 특별 혜택 마스터카드 특별 혜택 뜬 칸",
                    date: "2025 4.5",
                  ),
                  SizedBox(height: 20),
                  _BlogCard(
                    ...
                    title: " 마스터카드 특별 혜택 ",
                    description:
                        "  여기서만 제공되는 특별한 마스터카드 특별 혜택 마스터카드 특별 혜택 파트너십과 혜택마스터카드 특별 혜택 마스터카드 특별 혜택 ",
                    date: "2025 4.5 ",
                  ),
                  SizedBox(height: 20),
                  _BlogCard(
                    ...
                    title: " 마스터카드 특별 혜택 ",
                    description:
                        " 여기서만 제공되는 특별한 마스터카드 특별 혜택 마스터카드 특별 혜택파트너십과 혜택 마스터카드 특별 혜택 마스터카드 특별 혜택  ",
                    date: "2025 4.5 ",
                  ),
                  SizedBox(height: 20),
                  _BlogCard(
                    ...
                    title: " 마스터카드 특별 혜택 ",
                    description:
                        "   여기서만 제공되는 특별한 파트너십과 혜택 마스터카드 특별 혜택 마스터카드 특별 혜택 마스터카드 특별 혜택 ",
                    date: "2025 4.5 ",
                  ),
                ],
              ),
